...
// =========================================================================================
// =========================================================================================
// START OBS (WITH RAW UNFILTERED LOGS)
// =========================================================================================
async function startOBS() {
    ...
    // 🚨 FULL RAW LOGS ENABLED (Bina kisi filter ke)
    obsProcess.stdout?.on('data', data => {
        console.log(`[OBS RAW] ${data.toString().trim()}`);
    });
    obsProcess.stderr?.on('data', data => {
        console.log(`[OBS RAW ERR] ${data.toString().trim()}`);
    });
    ...
    try {
        ...
        if (status.outputActive) {
            ...
            console.log(`[💡] Upar [OBS RAW] logs dekhein, wahan likha hoga ke connection kyun drop hua!`);
        }
    } catch (e) {
